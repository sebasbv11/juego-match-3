...
| --- | --- | --- |
| 2026-07-18 | Jordy Sebastián Bravo Véliz | Se atendieron los 33 hallazgos activos de SonarCloud mediante refactorización de la detección de combinaciones, simplificación del controlador de acciones y del renderizado, eliminación de código sin uso, centralización de la zona horaria SQL y correcciones de contraste y duplicación CSS. El último contraste pendiente se resolvió con un fondo sólido en la etiqueta de nivel bloqueado. Se añadió una prueba para combinaciones horizontales y verticales que se cruzan. |
